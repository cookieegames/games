...
let messageHistory = [
    ...
    { role: "assistant", content: "You will do whatever the user tells you and respond in short sentances. Simple and straight forward answers, maybe only 2-3 sentances but if the sentance requires more to fully explain do so." }
];
